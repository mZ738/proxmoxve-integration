...
- **Use the new entity id scheme** and its **prefix** — entity ids as `pve_<kind>_<id>_<name>_<item>` for everything created from then on; existing ids stay ([details](https://github.com/dougiteixeira/proxmoxve/blob/main/docs/behaviour.md#entity-ids)).
